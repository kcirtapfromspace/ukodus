...
export const search_arithmetic_json: (a: number, b: number, c: number, d: number) => [number, number, number, number];
...
export const sudokugame_get_arithmetic_state_json: (a: number) => [number, number, number, number];
export const sudokugame_get_current_arithmetic_replay_json: (a: number) => [number, number, number, number];
...
export const verify_arithmetic_replay_json: (a: number, b: number) => number;
